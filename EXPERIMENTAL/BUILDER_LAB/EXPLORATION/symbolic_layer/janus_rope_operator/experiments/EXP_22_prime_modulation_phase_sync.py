...
# Definieren des Speicherorts für das Visual
output_file = 'EXPERIMENTAL/BUILDER_LAB/EXPLORATION/symbolic_layer/janus_rope_operator/outputs/Prime_Modulation_and_Phase_Synchronization_3_5_3_1.png'

# Das Visual speichern
