...
# Halvorsen System
def halverson_system(X, t, p, q, r):
    x, y, z = X
    dxdt = p * (y - x)
    dydt = x * (r - z) - y
    dzdt = x * y - q * z
...
halvorsen_solution = odeint(halverson_system, X0, t, args=(p, q, r))
...
rossler_halvorsen_sync = calculate_sync(rossler_solution, halverson_solution)
lorenz_halvorsen_sync = calculate_sync(lorenz_solution, halverson_solution)
