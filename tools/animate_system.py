...
def simulate(system_path):
    ...
    return system, regime_map, risk_geometry, safe_traj, naive_traj


def animate(system, regime_map, risk_geometry, safe_traj, naive_traj):
    ...
    def draw_base():
        ...
        ax.set_title("NEXAH Navigation — Safe Agent vs Collapse Agent")
...
if __name__ == "__main__":
    ...
    system, regime_map, risk_geometry, safe_traj, naive_traj = simulate(SYSTEM_PATH)

    print("Safe trajectory:", safe_traj)
    print("Naive trajectory:", naive_traj)

    animate(system, regime_map, risk_geometry, safe_traj, naive_traj)
