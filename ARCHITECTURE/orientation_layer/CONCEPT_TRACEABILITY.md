...
|---|---|---|---|---|
| Orientation | Evidence-aware process for locating and relating possible action | Repository-wide research framing | Defined concept | Operationalize through contracts |
| Q° Orientation Core | Contextual orientation and reporting boundary | Conceptual design | Planned | Implement typed state and report |
...
| Frozen v0.7 Engine | Locally fitted state-space and transition analysis | `nexah/core.py` | Implemented baseline | Characterize and adapt |
...
| Orientation Report | Evidence-linked decision-support output | Not implemented | Planned | Define schema and generator |
