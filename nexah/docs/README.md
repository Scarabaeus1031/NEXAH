...
These documents describe or record the minimal `nexah` package.

- **[CORE_V07_REFERENCE.md](CORE_V07_REFERENCE.md)** — behavior described for
  the historical v0.7 freeze; verify statements against current code and tests.
- **[BASELINE_STATUS.md](BASELINE_STATUS.md)** — current characterized scope,
