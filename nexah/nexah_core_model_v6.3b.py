...
# Dummy Trajectory (REMOVE when using real data!)
...
# Winkel entlang der Trajektorie
...
```
# --------------------------------------------------------
# 1. Generate trajectory (REPLACE with real traj!)
# --------------------------------------------------------
