...
In that sense, `nexah/` is the place where the framework becomes **NEXAH itself** — readable, geometric, and increasingly navigable.
...
→ **toward structured movement and navigation**
...
If `ENGINE/` computes and `FRAMEWORK/` defines architecture,
...
Its purpose is to gather the layer in which:
...
```text
CORE
    → structure, field, geometry, channel, switch
