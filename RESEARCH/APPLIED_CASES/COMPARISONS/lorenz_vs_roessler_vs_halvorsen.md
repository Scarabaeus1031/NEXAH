...
```text
different geometry
→ same structural extraction pipeline
```
...
```text
density is universal structural carrier
```
...
```text
structure emerges from flow alignment
```
...
```text
continuous dynamics induce discrete layers
```
...
```text
systems behave like constrained Markov processes
```
...
Rössler    → transport-dominated
Halvorsen  → distributed-dominated
```
