# ============================================================
# EXP_07 — DRIFT FIELD RECONSTRUCTION
# JANUS Rope Operator / Residue Drift Geometry
#
# Goal:
# Reconstruct local drift vectors inside modular residue space.
#
# Outputs:
# 1. Local drift vector field
# 2. Residue flow lattice
# 3. Drift strength heatmap
# 4. Transport corridor overlay
# 5. Modular vortex reconstruction
#
...
ax.set_title(
    "EXP_07 — Local Drift Vector Field",
    fontsize=22
)
...
plt.tight_layout()
plt.savefig(
    "exp07_local_drift_vector_field.png",
    dpi=300
)
...
plt.tight_layout()
plt.savefig(
    "exp07_residue_flow_lattice.png",
    dpi=300
)

# ============================================================
# VISUAL 3
# DRIFT STRENGTH HEATMAP
# ============================================================
...
ax.set_title(
    "EXP_07 — Residue Drift Strength",
    fontsize=22
)

plt.tight_layout()
plt.savefig(
    "exp07_residue_drift_strength.png",
    dpi=300
)
...
ax.set_title(
    "EXP_07 — Transport Corridor Overlay",
    fontsize=22
)
...
ax.set_title(
    "EXP_07 — Modular Vortex Reconstruction",
    fontsize=24
)
...
plt.tight_layout()
plt.savefig(
    "exp07_modular_vortex_reconstruction.png",
    dpi=300
)
...
print("\n===================================")
print("EXP_07 — DRIFT FIELD RECONSTRUCTION")
print("===================================\n")
