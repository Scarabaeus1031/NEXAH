...
* $begin:math:text$ A\(t\) $end:math:text$ is the amplitude of the wave.
* $begin:math:text$ A\_0 $end:math:text$ is the maximum amplitude.
* $begin:math:text$ \\omega $end:math:text$ is the angular frequency (rate of oscillation).
...
* $begin:math:text$ x\(t\) $end:math:text$ and $begin:math:text$ y\(t\) $end:math:text$ are the two functions.
...
Solving for $begin:math:text$ t $end:math:text$:

$$
\frac{3}{5} \cdot t = 3 \cdot t \quad \Rightarrow \quad \left( \frac{3}{5} - 3 \right) \cdot t = 0
$$

This results in the solution $begin:math:text$ t \= 0 $end:math:text$, indicating that the waves synchronize at $begin:math:text$ t \= 0 $end:math:text$. Further crossing points can be calculated based on their periodicity.
