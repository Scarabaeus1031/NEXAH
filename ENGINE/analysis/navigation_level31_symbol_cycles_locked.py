...
ALPHA_FLOW = 0.18
BETA_SWIRL = 0.22
GAMMA_MEMORY = 0.85  # 🔥 stronger memory

MEMORY_DECAY = 0.999  # 🔥 longer persistence
...
# 🔥 NEW: LOCKING SYSTEM
SYMBOL_LOCK_PROB = 0.85
SYMBOL_ATTRACTION = 0.9
...
axs[0, 0].set_title("Symbol Memory (Locked)")
...
img_path = os.path.join(SAVE_DIR, f"level31_{MODE}_{run_id}.png")
...
with open(os.path.join(LOG_DIR, f"level31_{MODE}_{run_id}.json"), "w") as f:
