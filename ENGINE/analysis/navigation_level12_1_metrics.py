...
SAVE_DIR = "ENGINE/visuals/navigation_level12_1"
LOG_DIR = "ENGINE/logs"
...
def plot_results(base, history, paths_all):
    ...
    path = os.path.join(SAVE_DIR, "level12_1_metrics.png")
...
if __name__ == "__main__":
    ...
    metrics = {
        "entropy": float(compute_entropy(field)),
        "peak": float(compute_peak(field)),
        "spread": float(compute_spread(field)),
