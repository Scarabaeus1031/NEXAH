...
def main():
    ...
    landscape = generate_stability_landscape()          # aus deinem ENGINE-Modul
    paths = []
    final_positions = []
    ...
    if BRIDGE_AVAILABLE:
        try:
            ...
            print("Bridge-Info nicht verfügbar:", e)
    animate_agents(landscape, paths, clusters, save_path="nexah_multi_agent.gif")
