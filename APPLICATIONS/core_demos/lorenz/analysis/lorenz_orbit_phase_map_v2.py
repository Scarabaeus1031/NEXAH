"""
NEXAH — Lorenz Orbit Phase Map v2

Goal:
Fix phase collapse by using quantile-based phase mapping.

Now:
→ full attractor gets structured coloring
→ real phase zones emerge
"""
...
# ==================================================
# 4. QUANTILE PHASE MAPPING (KEY FIX)
# ==================================================
...
ax.set_title("Orbit Phase Map v2 (Quantile-Based)")
...
ax3.set_title("Phase (Quantile) over Time")
...
ax4.set_title("Phase Distribution (Uniform)")


plt.tight_layout()
plt.savefig("APPLICATIONS/outputs/lorenz_orbit_phase_map_v2.png", dpi=150)
plt.show()
...
print("\n🧭 Interpretation:")
print("""
Phase is now evenly distributed.

→ full attractor becomes visible
→ real zones emerge
→ segmentation becomes meaningful

----------------------------------------

🧠 Key Insight:

Phase must be distribution-aware.

NOT:
    phase = value

BUT:
    phase = position in distribution

----------------------------------------

🚀 Meaning:

This is the first TRUE phase field.
