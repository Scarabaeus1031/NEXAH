...
# ============================
# 2. Simulate trajectory (NOISY)
# ============================

dt = 0.01
steps = 4000
noise_strength = 2.0  # 🔥 KEY PARAM
...
ax.set_title("Lorenz (Noisy) — colored by Coherence")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
...
ax2.plot(coherence, linewidth=1)
ax2.set_title("Coherence over Time (Noisy)")
ax2.set_xlabel("Step")
ax2.set_ylabel("C(x)")


plt.tight_layout()
plt.savefig("APPLICATIONS/core_demos/lorenz_nexah_v2_noisy.png", dpi=150)
plt.show()
