...
n_agents = 8
coupling_strength = 0.05  # 🔥 KEY PARAM
...
for _ in range(steps):
    ...
    for i in range(n_agents):
        ...
        # 🔥 interaction term
        interaction = coupling_strength * (mean_state - x)
...
ax.set_title("V6: Multi-Agent Interaction (Emergence)")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
...
ax2.set_title("Mean Coherence (Coupled System)")
ax2.set_xlabel("Step")
ax2.set_ylabel("C(x)")


plt.tight_layout()
plt.savefig("APPLICATIONS/core_demos/lorenz_nexah_v6_interaction.png", dpi=150)
plt.show()
