...
It uses a BFS graph search to find a path from the start state
to any state belonging to a target regime.
...
def save_report(lines):
    ...
    report_file = os.path.join(OUTPUT_DIR, "lorenz_navigation_report.txt")
...
if __name__ == "__main__":
    main()    node_states = adapter.node_states

    path_file = os.path.join(OUTPUT_DIR, "lorenz_navigation_path.csv")
