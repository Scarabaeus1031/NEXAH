"""
v34_root_cube_navigation_controller.py
======================================

NEXAH v34 – Golden Scarabaeus Möbius Breathing Pulse + 7-Arc + 5×17 Full Break
Stark ausbalanciert – sanfter, stabiler, keine Explosion mehr
"""
...
TS_PATH    = OUTDIR / "ieee57_v34_root_cube_timeseries.png"
POLAR_PATH = OUTDIR / "ieee57_v34_root_cube_polar.png"
CUBE_PATH  = OUTDIR / "ieee57_v34_root_cube_3d_projection.png"
REPORT_PATH= OUTDIR / "ieee57_v34_root_cube_report.txt"

print(f"📁 Speichere in: {OUTDIR}")

# ============================================================
# 1. SETTINGS (sanft & stabil für v34)
# ============================================================
TIME_STEPS = 300
SEED = 42
...
# Ausbalancierte Werte
K_LIFT          = 0.82
K_R_HOLD        = 1.08
K_FLOW          = 0.265
K_AXIS_PULL     = 0.28          # deutlich sanfter
K_SNAP          = 0.20
BREATH_FREQ     = 0.118
BREATH_AMP      = 0.028         # sanfteres Atmen
BREATH_TWIST    = 0.011
NUDGE_AMP       = 0.022
PRIME_BREAK     = 64
...
# 4. RUN & SAVE
# ============================================================
baseline, controlled, escape_count = simulate_v34()

report = f"""NEXAH v34 Root Cube Navigation Report (7-Arc + 5×17 Full Break)
========================================
...
print(f"✅ v34 erfolgreich ausgeführt!")
