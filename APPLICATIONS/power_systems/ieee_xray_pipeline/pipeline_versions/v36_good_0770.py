...
NEXAH v36 GOOD 0770 – exakt die stabile Version mit Mean control signal ≈ -0.0770
Eindeutige Dateinamen + volle Plots + Save-Check
"""
...
TS_PATH    = OUTDIR / "v36_good_0770_timeseries.png"
POLAR_PATH = OUTDIR / "v36_good_0770_polar.png"
CUBE_PATH  = OUTDIR / "v36_good_0770_3d.png"
REPORT_PATH= OUTDIR / "v36_good_0770_report.txt"

print(f"📁 Speicherort: {OUTDIR.resolve()}\n")

# ============================================================
# 1. SETTINGS – exakt die gute v36 mit -0.0770
# ============================================================
np.random.seed(42)
...
# 2. REPORT
# ============================================================
report = f"""NEXAH v36 GOOD 0770 FINAL STABLE
...
save_plot(fig, TS_PATH, "v36_good_0770 Timeseries")

# Polar
fig = plt.figure(figsize=(10, 10))
ax = fig.add_subplot(111, projection='polar')
ax.plot(controlled["radius"], controlled["gate_score"], 'b-')
save_plot(fig, POLAR_PATH, "v36_good_0770 Polar")
...
save_plot(fig, CUBE_PATH, "v36_good_0770 3D Cube")

print("\n✅ v36_good_0770 fertig – bitte schick mir den kompletten Konsolen-Output!")
