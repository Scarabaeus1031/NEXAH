"""
NEXAH IEEE 57 Pipeline v3 — Detection Comparison
===============================================

Goal:
Compare classical voltage collapse detection vs NEXAH structural detection
"""
...
if classical_event:
    ax[0].axvline(classical_event, linestyle="--")
...
plt.suptitle("NEXAH vs Classical Collapse Detection")
...
plt.savefig(save_dir / "ieee57_pipeline_v3_detection.png", dpi=200)
plt.close()

print(f"\nSaved: {save_dir}/ieee57_pipeline_v3_detection.png")
