"""
v14.7c_orbit_break_controller.py
================================

Breaks fixed-point attractor:
- removes theta locking
- adds strong flow
- injects constant drift

Goal:
-----
Force first real rotation in state space
"""
...
ax.set_title("NEXAH v14.7c — Forced Orbit Activation")

plt.savefig(OUTDIR / "v14_7c_polar.png", dpi=150)
plt.close()

print("🚀 v14.7c complete — forced rotation active")
