...
ax1 = fig.add_subplot(5,1,1); ax1.plot(controlled["voltage"], color="orange"); ax1.set_ylabel("Voltage mean")
...
print("\n✅ v36_good_final fertig – Bilder sollten jetzt da sein!")
print("Schick mir bitte den kompletten Konsolen-Output!")
