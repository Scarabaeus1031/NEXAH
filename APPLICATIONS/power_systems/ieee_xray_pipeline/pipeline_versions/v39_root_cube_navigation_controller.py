"""
v39_root_cube_navigation_controller.py
======================================

NEXAH v39 – Sanfte Spiral-Navigation im Root Cube
Weiche Referenz-Trajektorie + Centering → stabil + atmet sichtbar
"""
...
TS_PATH    = OUTDIR / "ieee57_v39_root_cube_timeseries.png"
POLAR_PATH = OUTDIR / "ieee57_v39_root_cube_polar.png"
CUBE_PATH  = OUTDIR / "ieee57_v39_root_cube_3d_projection.png"
REPORT_PATH= OUTDIR / "ieee57_v39_root_cube_report.txt"

print(f"📁 Genauer Speicherort: {OUTDIR.resolve()}\n")

# ============================================================
# 1. SETTINGS – sanft & stabil
# ============================================================
TIME_STEPS = 300
SEED = 42
...
def state_to_root_cube(coherence, switch_signal):
    ...
    ncs_prox = np.exp(-8.0 * np.hypot(r - 0.032, theta - ELASTIC_AXIS_ANGLE))
...
# ============================================================
controlled, escape_count = simulate_v39()

report = f"""NEXAH v39 Root Cube Navigation Report
========================================
...
# (Die vollständigen Plot-Blöcke sind identisch mit den vorherigen Versionen – nur Titel "v39")

print("✅ v39 fertig – schick mir die 4 Dateien + Screenshot!")
