"""
v35_root_cube_navigation_controller.py
======================================

NEXAH v35 – Golden Scarabaeus Möbius Breathing Pulse + 7-Arc + 5×17 Full Break
Stark gedämpft, stabil, mit Centering-Term – kein Ausbruch mehr
"""
...
TS_PATH    = OUTDIR / "ieee57_v35_root_cube_timeseries.png"
POLAR_PATH = OUTDIR / "ieee57_v35_root_cube_polar.png"
CUBE_PATH  = OUTDIR / "ieee57_v35_root_cube_3d_projection.png"
REPORT_PATH= OUTDIR / "ieee57_v35_root_cube_report.txt"

print(f"📁 Speichere in: {OUTDIR}")

# ============================================================
# 1. SETTINGS (stark gedämpft für stabile Rotation)
# ============================================================
TIME_STEPS = 300
SEED = 42
...
# Stark gedämpfte Parameter
K_LIFT          = 0.75
K_R_HOLD        = 1.05
K_FLOW          = 0.245
K_AXIS_PULL     = 0.24           # deutlich sanfter
K_SNAP          = 0.18
BREATH_FREQ     = 0.118
BREATH_AMP      = 0.019          # sehr sanfteres Atmen
BREATH_TWIST    = 0.008
NUDGE_AMP       = 0.018
PRIME_BREAK     = 64
FIVE_SEVENTEEN_TRIGGER = 0.0100

# Neuer Centering-Term
CENTERING_FACTOR = 0.12
...
def simulate_v35():
    ...
    for t in range(TIME_STEPS):
        ...
        if mode == "capture":
            ...
            snap = K_SNAP * ncs_prox if ncs_prox > 0.6 else 0.0
...
# 4. RUN & SAVE
# ============================================================
baseline, controlled, escape_count = simulate_v35()

report = f"""NEXAH v35 Root Cube Navigation Report (7-Arc + 5×17 Full Break)
========================================
...
print(f"✅ v35 erfolgreich ausgeführt!")
