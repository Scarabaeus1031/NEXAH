...
Mit Agg-Backend + Save-Check → Bilder werden jetzt garantiert geschrieben
"""

import matplotlib
matplotlib.use('Agg')   # WICHTIG für Mac
...
# (Hier die 5 Subplots – für diesen Test reicht erstmal ein einfacher Plot)
