...
TS_PATH    = OUTDIR / "ieee57_v17_root_cube_timeseries.png"
POLAR_PATH = OUTDIR / "ieee57_v17_root_cube_polar.png"
...
def simulate_v17(time_steps=TIME_STEPS, seed=SEED):
    np.random.seed(seed)
    net = pp.networks.case57()
    base_p = net.load["p_mw"].copy()
    base_q = net.load.get("q_mvar", None)
...
controlled = simulate_v17()

print("✅ v17 erfolgreich ausgeführt!")
