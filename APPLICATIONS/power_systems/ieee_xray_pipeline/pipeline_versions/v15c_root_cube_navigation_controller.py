...
POLAR_PATH = OUTDIR / "ieee57_v15c_root_cube_polar.png"
...
axs[0].plot(t, controlled["voltage_mean"], label="v15c Controlled")
...
fig.suptitle("NEXAH v15c – Root Cube Navigation Controller")
fig.tight_layout()
...
ax.set_title("3D Root Cube Projection (v15c)")
fig.tight_layout()
fig.savefig(CUBE_PATH, dpi=160)
plt.close(fig)

# Report (NaN-safe)
report = f"""NEXAH v15c Root Cube Navigation Report
========================================
