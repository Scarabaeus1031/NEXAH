...
# === Balance: später Trigger + starke Zither ===
ALPHA_FLOW = 0.95
BETA_SWIRL = 0.65
GAMMA_MEMORY = 0.40
...
def nexah_lorenz_ode(t, x):
    ...
    d_phi = 0.0
    if t > 25.0 and abs(dc) > WINDING_THRESHOLD:
        d_phi = 28.0 + 18.0 * (phi == 2)   # starker Boost, aber später
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 300-Bus Netz... (v13.10 Janus + Lyapunov – Balance Test)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Janus + Lyapunov v13.10)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.10_janus_lyapunov.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.10_janus_lyapunov.png")
plt.show()
