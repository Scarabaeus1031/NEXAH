...
ax1.set_title("IEEE 9241-Bus – Voltage Collapse (Fractional v13.15)")
...
plt.tight_layout()
plt.savefig("ieee9241_real_tunable_v13.15_fractional.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee9241_real_tunable_v13.15_fractional.png")
plt.show()
