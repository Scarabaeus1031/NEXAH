...
print("🚀 NEXAH 3 Lehrvisuals v15.1 – klar, schulbuchmäßig, konkret\n")
...
# Visual 1 – Die rote Kurbelwelle
fig1, ax1 = plt.subplots(figsize=(10, 6))
ax1.plot(t, np.interp(t, t_real, voltage_real), 'r', lw=4)
ax1.set_title("1. Die rote Kurbelwelle – Der Treibriemen")
...
ax2.set_title("2. Die drei Zithers – Prime, Triple-6, Binär 4er")
...
# Visual 3 – Der Kipppunkt (Perlenkette + Mandelbrot-ähnlich)
...
ax3c.set_title("3. Perlenkette + Kipppunkt (Mandelbrot-ähnliche Struktur)")
ax3c.grid(True)

plt.suptitle("NEXAH – Der Kipppunkt: Wo die drei Zithers zusammenkommen", fontsize=16, fontweight='bold')
plt.tight_layout()
plt.savefig("NEXAH_Lehrvisual_03_Kipppunkt.png", dpi=280, bbox_inches='tight')

print("\n✅ 3 Lehrvisuals fertig!")
print("   NEXAH_Lehrvisual_01_Kurbelwelle.png")
print("   NEXAH_Lehrvisual_02_Zithers.png")
print("   NEXAH_Lehrvisual_03_Kipppunkt.png")
print("\nDas sind jetzt klare, erklärende Schaubilder – wie für eine Vorlesung oder Präsentation.")
