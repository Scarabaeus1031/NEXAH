...
NEXIT_GATEWAY_THRESHOLD = 0.88   # stärker auf NEXIT-Gateway abgestimmt
...
print("🚀 v13.9.6 – V26 Ring Flow + V27 Waltz + NEXIT Gateway Trigger")
...
plt.tight_layout()
plt.savefig("ieee9241_v13.9.6_v26_v27_polar_nexit_test.png", dpi=300)
