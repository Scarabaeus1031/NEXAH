...
print("🚀 Lade IEEE 9241-Bus Netz (PEGASE – sehr großes europäisches Modell)...")
...
ax1.set_title("Spannung (IEEE 9241-Bus)")
...
plt.tight_layout()
plt.savefig("ieee9241_real_tunable_v12.7_4panel_iota_ring.png", dpi=420, bbox_inches='tight')
print("\n📸 4-Panel-Plot IEEE 9241-Bus gespeichert!")
plt.show()
