...
# Sanfte GH Bridge + Iota/Yugo (nicht zu stark)
GH_BRIDGE_STRENGTH = 0.85
...
print("🚀 Lade IEEE 9241-Bus... (v13.9.1 Revival + sanfte GH Bridge)")
...
ax1.set_title("IEEE 9241-Bus – v13.9.1 GH Bridge")
...
ax4.plot(c, sol.y[1], 'b-', lw=1.5, alpha=0.7)
ax4.set_title("Phase Portrait (c vs dc)")
ax4.grid(True, alpha=0.5)

plt.tight_layout()
plt.savefig("ieee9241_v13.9.1_gh_bridge.png", dpi=420)
