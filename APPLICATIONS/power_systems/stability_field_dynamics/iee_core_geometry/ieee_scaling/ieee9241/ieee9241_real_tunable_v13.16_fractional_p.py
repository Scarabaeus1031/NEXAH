...
# Fractional Tuning (deine Idee A + B = R/T)
PHI_FRACTION = 64/64
...
def nexah_lorenz_ode(t, x):
    ...
    d_dc = (ALPHA_FLOW * f_field 
            ...
            + f_iota_yugo 
            + f_janus 
            + f_lyapunov) * I_phi * slow_start * contraction * ALPHA_FRACTION
...
print("🚀 Lade IEEE 9241-Bus Netz (PEGASE)... (v13.16 Fractional P-Regulator)")
...
ax1.set_title("IEEE 9241-Bus – Voltage Collapse (Fractional P v13.16)")
...
plt.tight_layout()
plt.savefig("ieee9241_real_tunable_v13.16_fractional_p.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee9241_real_tunable_v13.16_fractional_p.png")
plt.show()
