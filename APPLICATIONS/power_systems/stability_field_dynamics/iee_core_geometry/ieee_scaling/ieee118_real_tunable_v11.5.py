...
def nexah_lorenz_ode(t, x, vm_history):
    ...
    d_phi = resonance + 1.8 * winding_number + 8.5 * drift_boost
    
    # Zeit-Guard + starker Kipper-Trigger
