...
N_BANDS = [0.429, 0.456, 0.487]   # <-- das sind die entscheidenden Resonanzbänder
...
def nexah_lorenz_ode(t, x):
    ...
    # === WINDING NUMBER mit N_BANDS (der Schlüssel zum Split) ===
    theta = t * 3.6
    ...
    d_phi = 2.5 * winding_number   # verstärkt – das war in den erfolgreichen Versionen der Treiber
    
    # Sicherer, aber natürlicher Trigger
...
print("🚀 IEEE 300-Bus – v12.7 mit vollen N_BANDS + starkem winding_number")
net = pn.case300()
...
plt.suptitle("IEEE 300-Bus – v12.7 mit vollen N_BANDS + Perlenkette", fontsize=16)
plt.tight_layout()
