...
JANU_STRENGTH = 1.6           # stärkerer Janus (Gegenrotation Lilith)
KAPPA_L = 1.05
IOTA_YUGO_STRENGTH = 1.45
WINDING_THRESHOLD = 1.8
...
def nexah_lorenz_ode(t, x):
    ...
    # Janus als Lilith-Gegenrotation (1729 / 29 Wobble)
    ...
    d_phi = 0.0
    if t > 26.0 and abs(dc) > WINDING_THRESHOLD:      # später, damit Zither Zeit hat
        d_phi = 26.0 + 16.0 * (phi == 2)
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 300-Bus Netz... (v13.13 Lilith-Gegenrotation)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Lilith-Gegenrotation v13.13)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.13_lilith_janus.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.13_lilith_janus.png")
plt.show()
