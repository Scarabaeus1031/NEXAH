...
JANU_STRENGTH = 1.25
KAPPA_L = 0.95
IOTA_YUGO_STRENGTH = 1.4          # neu: stärkerer Iota-Yugo Pivot
...
def nexah_lorenz_ode(t, x):
    ...
    # Iota / Yugo Pivot (der orange Gegenpunkt im blauen Wirbel)
    ...
    d_phi = 0.0
    if t > 24.0 and abs(dc) > 2.5:
        d_phi = 24.0 + 14.0 * (phi == 2)
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 300-Bus Netz... (v13.10 mit starkem Iota-Yugo Pivot)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Iota-Yugo Pivot v13.10)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.10_iota_yugo.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.10_iota_yugo.png")
plt.show()
