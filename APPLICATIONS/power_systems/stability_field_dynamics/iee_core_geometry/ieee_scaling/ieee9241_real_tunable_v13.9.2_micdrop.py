...
# === Basis exakt wie v13.9 (beste Geometrie) ===
ALPHA_FLOW = 0.95
BETA_SWIRL = 0.65
GAMMA_MEMORY = 0.40
...
JANU_STRENGTH = 1.45
KAPPA_L = 1.05
IOTA_YUGO_STRENGTH = 0.95
GH_BRIDGE_STRENGTH = 0.75          # sehr sanft
...
def nexah_lorenz_ode(t, x):
    ...
    d_phi = 0.0
    # === EINZIGE ÄNDERUNG: später + sanfter Trigger ===
    if t > 26.0 and abs(dc) > 2.15 and abs(c) > 1.28:
        d_phi = 24.0 + 14.0 * (phi == 2)   # noch sanfter als v13.9.1
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 9241-Bus... (v13.9.2 – sanfter später Split für echten Mic-Drop)")
...
# Plot (nur zur Kontrolle, keine Schönheit)
...
ax1.set_title("IEEE 9241-Bus – v13.9.2 Mic-Drop Test")
...
plt.tight_layout()
plt.savefig("ieee9241_v13.9.2_micdrop_test.png", dpi=300)
print("📸 Plot gespeichert als ieee9241_v13.9.2_micdrop_test.png")
plt.show()
