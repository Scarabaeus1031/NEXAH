...
def nexah_lorenz_ode(t, x, vm_history):
    ...
    d_phi = resonance + 2.0 * winding_number + 12.0 * drift_boost
...
print("🚀 Lade echtes IEEE 118-Bus Netz... (v12.1 mit vollem 7-Arc Lattice)")
net = pn.case118()
...
ax2.set_title("Phi-Regulator Zustand (7-Arc Lattice + starker Bügel)")
...
plt.tight_layout()
plt.savefig("ieee118_real_tunable_v12.1_4panel_7arc_lattice.png", dpi=420, bbox_inches='tight')
print("\n📸 4-Panel-Plot mit vollem 7-Arc Lattice gespeichert!")
plt.show()
