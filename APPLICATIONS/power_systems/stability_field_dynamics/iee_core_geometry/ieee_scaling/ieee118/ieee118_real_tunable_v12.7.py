...
def nexah_lorenz_ode(t, x, vm_history):
    ...
    # === ABSOLUTER LOCK + IOTA-RING AKTIVIERUNG ===
    if t < 36.0:
        d_phi = 0.0
        return [dc * contraction, d_dc, 0.0]   # phi_idx bleibt 0
    else:
...
print("🚀 Lade echtes IEEE 118-Bus Netz... (v12.7 mit IOTA-RING + ABSOLUTEM Lock)")
net = pn.case118()
...
plt.tight_layout()
plt.savefig("ieee118_real_tunable_v12.7_4panel_iota_ring.png", dpi=420, bbox_inches='tight')
print("\n📸 4-Panel-Plot mit IOTA-RING gespeichert!")
plt.show()
