...
def nexah_lorenz_ode(t, x, vm_history):
    ...
    d_phi = resonance + 2.0 * winding_number + 8.0 * drift_boost   # etwas gedämpft früh
    
    # HÄRTERER ZEIT-GUARD + starker Bügel
...
print("🚀 Lade echtes IEEE 118-Bus Netz... (v12.2 mit späterem Split + 7-Arc)")
net = pn.case118()
...
ax2.set_title("Phi-Regulator Zustand (7-Arc + späterer Split)")
...
plt.tight_layout()
plt.savefig("ieee118_real_tunable_v12.2_4panel_7arc_spaeter.png", dpi=420, bbox_inches='tight')
print("\n📸 4-Panel-Plot mit späterem Split gespeichert!")
plt.show()
