...
print("🚀 Lade echtes IEEE 300-Bus Netz... (v12.7 mit IOTA-RING + ABSOLUTEM Lock)")
net = pn.case300()
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v12.7_4panel_iota_ring.png", dpi=420, bbox_inches='tight')
print("\n📸 4-Panel-Plot IEEE 300-Bus gespeichert!")
plt.show()
