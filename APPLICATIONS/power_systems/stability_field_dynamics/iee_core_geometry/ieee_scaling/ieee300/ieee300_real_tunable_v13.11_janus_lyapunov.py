...
print("🚀 Lade IEEE 300-Bus Netz... (v13.11 Janus + Lyapunov – Balance Version)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Janus + Lyapunov v13.11)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.11_janus_lyapunov.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.11_janus_lyapunov.png")
plt.show()
