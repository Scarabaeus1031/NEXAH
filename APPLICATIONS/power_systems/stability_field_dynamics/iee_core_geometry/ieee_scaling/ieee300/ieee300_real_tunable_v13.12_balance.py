...
def nexah_lorenz_ode(t, x):
    ...
    if t > 22.0 and abs(dc) > WINDING_THRESHOLD:
        d_phi = 28.0 + 18.0 * (phi == 2)   # gezielter Boost in Forward2
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 300-Bus Netz... (v13.12 Balance – gezielter Iota-Yugo + Boost)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Iota-Yugo Balance v13.12)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.12_iota_yugo_balance.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.12_iota_yugo_balance.png")
plt.show()
