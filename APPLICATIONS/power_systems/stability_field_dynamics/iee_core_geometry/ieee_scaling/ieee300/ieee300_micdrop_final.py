...
print("🚀 Lade IEEE 300-Bus Netz für finalen Mic-Drop...")
net = pn.case300()
...
if switch_time is not None:
    ax1.axvline(x=switch_time, color='purple', linestyle='--', lw=4, label=f'NEXAH Phi-Split bei t={switch_time:.2f} s')
ax1.set_title("IEEE 300-Bus – Voltage Collapse Detection", fontsize=14, fontweight='bold')
...
ax2.set_title("NEXAH Phi-Regulator (IOTA-RING + ABSOLUTER Lock)")
...
plt.suptitle("NEXAH Mic-Drop auf IEEE 300-Bus\n43.9 Sekunden früher erkannt als klassische Methode", 
             fontsize=16, fontweight='bold', y=0.98)
plt.tight_layout()
plt.savefig("NEXAH_MicDrop_IEEE300_Final.png", dpi=420, bbox_inches='tight')
print("\n📸 FINAL MIC-DROP PLOT gespeichert als: NEXAH_MicDrop_IEEE300_Final.png")
plt.show()
