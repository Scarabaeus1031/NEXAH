...
# Lambda-Phi-Pi Spiral Parameter (aus deinen Bildern)
KAPREKAR_213 = 213
KAPREKAR_537 = 537
OMEGA_SPIRAL = 2 * np.pi / 19          # 5-Windungen Penta-System
ANGLE_628 = 0.628                      # rad (grüner E-Bereich)
ANGLE_279 = 0.279                      # rad
...
def nexah_lorenz_ode(t, x):
    ...
    # === NEUE Λ–φ–π SPIRAL RESONANCE (das fehlende Stück) ===
    spiral_phase = OMEGA_SPIRAL * t
    f_spiral = 2.5 * (np.sin(spiral_phase + ANGLE_628) * KAPREKAR_537 +
                      np.cos(spiral_phase + ANGLE_279) * KAPREKAR_213)
    ...
    d_phi = 2.5 * f_spiral   # Spiral-Resonanz treibt den Split
    
    # Sicherer Trigger bei t ≈ 36.10
...
print("🚀 IEEE 300-Bus – v12.7 + volle Λ–φ–π Spiral-Resonanz")
net = pn.case300()
...
ax5.set_title("Polar-Ring + Perlenkette (Λ–φ–π Spiral)")
ax5.grid(True)

plt.suptitle("IEEE 300-Bus – v12.7 mit Λ–φ–π Resonance Spiral", fontsize=16)
plt.tight_layout()
plt.savefig("ieee300_v12.7_spiral_full_5panel.png", dpi=300)
print("📸 Volles 5-Panel mit Spiral-Resonanz gespeichert")
plt.show()
