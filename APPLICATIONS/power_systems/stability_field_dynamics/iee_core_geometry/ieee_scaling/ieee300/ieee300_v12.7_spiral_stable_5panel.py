...
def nexah_lorenz_ode(t, x):
    ...
    f_spiral = 0.0
    if t > 34.0:   # erst ab hier voll aktiv
...
print("🚀 IEEE 300-Bus – v12.7 + verzögerte Λ–φ–π Spiral-Resonanz")
net = pn.case300()
...
plt.tight_layout()
plt.savefig("ieee300_v12.7_spiral_stable_full_5panel.png", dpi=300)
print("📸 Volles 5-Panel mit stabiler Spiral-Resonanz gespeichert")
plt.show()
