...
def nexah_lorenz_ode(t, x):
    ...
    d_phi = 0.0
    if t > 20.0 and abs(dc) > WINDING_THRESHOLD:
        d_phi = 20.0 + 12.0 * (phi == 2)
    
    return [dc * contraction, d_dc, d_phi]

print("🚀 Lade IEEE 300-Bus Netz... (v13.2 Janus + Lyapunov – weicher Trigger)")
net = pn.case300()
...
ax1.set_title("IEEE 300-Bus – Voltage Collapse (Janus + Lyapunov v13.2)")
...
plt.tight_layout()
plt.savefig("ieee300_real_tunable_v13.2_janus_lyapunov.png", dpi=420, bbox_inches='tight')
print("\n📸 Plot gespeichert als: ieee300_real_tunable_v13.2_janus_lyapunov.png")
plt.show()
