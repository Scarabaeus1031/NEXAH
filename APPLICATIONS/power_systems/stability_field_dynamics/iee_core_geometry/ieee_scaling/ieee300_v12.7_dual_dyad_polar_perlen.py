...
# Dual Dyad Werte für Farbzuordnung
dual_dyad_strength = np.array([0.63, 0.64, 0.83, 0.84])  # 63:64 | 83:84
...
print("🚀 IEEE 300-Bus – v12.7 mit Dual-Dyad gefärbter Perlenkette")
net = pn.case300()
...
# Farbverlauf basierend auf Dual-Dyad Stärke
colors = np.interp(phi_idx, [0,1,2,3,4], dual_dyad_strength)
...
plt.tight_layout()
plt.savefig("ieee300_v12.7_dual_dyad_perlen.png", dpi=300)
