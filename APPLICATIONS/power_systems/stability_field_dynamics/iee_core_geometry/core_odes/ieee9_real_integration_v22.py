"""
NEXAH Real IEEE 9-Bus Integration — Version 2.2
Stärkerer Load Ramp + höheres Q → Phi-Wechsel provozieren
"""
...
# ====================== STÄRKERE IEEE LOAD RAMP ======================
def ieee9_load_ramp(t):
    return 0.032 * t   # deutlich stärker als vorher
...
if __name__ == "__main__":
    print("🚀 NEXAH Real IEEE 9-Bus v2.2 — Stärkerer Drive + höheres Q")

    params = {'Q': 1.38, 'use_vdp': True}
    x0 = [0.05, 0.0, 0]
    ...
    fig.suptitle("NEXAH Real IEEE 9-Bus Simulation — v2.2 (stärkerer Drive)", fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig("ieee9_real_test_v22.png", dpi=220, bbox_inches='tight')
    print("📸 Plot gespeichert als: ieee9_real_test_v22.png")
    plt.show()
