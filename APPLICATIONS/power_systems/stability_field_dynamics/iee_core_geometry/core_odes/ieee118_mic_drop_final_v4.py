"""
NEXAH IEEE 118-Bus — MIC-DROP FINAL v4
...
# Triptych-Farben (wie MASTER V28)
...
def nexah_regime_ode(t, x, params):
    ...
    drift = abs(dc)
    d_phi = resonance * 2.1
    if drift > 1.8 and phi < 4:          # ← deutlich früherer Schnitt
        d_phi += 5.5
...
if __name__ == "__main__":
    print("🚀 NEXAH IEEE 118-Bus — MIC-DROP FINAL v4 (Triptych + früher Schnitt)")
    ...
    plt.tight_layout()
    plt.savefig("ieee118_mic_drop_final_v4.png", dpi=420, bbox_inches='tight')
    print("📸 MIC-DROP FINAL v4 (Triptych) gespeichert als: ieee118_mic_drop_final_v4.png")
    plt.show()
