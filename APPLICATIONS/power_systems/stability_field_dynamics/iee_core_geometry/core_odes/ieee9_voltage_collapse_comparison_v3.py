...
def classical_voltage(load_factor):
    return 1.0 / (1.0 + 0.62 * load_factor**2)

if __name__ == "__main__":
    print("🚀 NEXAH vs. Classical Voltage Collapse — v3.0 (phase-error-lock)")
    ...
    axs[2].plot(t, classical_voltage_curve, color='red', linewidth=2)
