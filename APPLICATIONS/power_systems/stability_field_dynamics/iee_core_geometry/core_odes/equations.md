...
This document summarizes the core mathematical structures developed in the 2D phase (v13–v3.8).
...
**Phi-Regulator Update (Dolphin-Flip trigger)**
\[
...
Q ≈ 1.62, λ ≈ 0.13, strong discrete pulse term.

This set of equations constitutes the **mathematical heart** of the NEXAH instrument and is the basis for all higher-dimensional extensions (3D polar grid etc.).
