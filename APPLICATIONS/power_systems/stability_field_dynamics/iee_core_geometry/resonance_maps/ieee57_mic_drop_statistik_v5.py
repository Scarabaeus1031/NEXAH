"""
NEXAH IEEE 57-Bus — STATISTIK v5
...
if __name__ == "__main__":
    print("🚀 NEXAH IEEE 57-Bus — STATISTIK v5 (20 Runs)")
    ...
    if np.any(valid):
        ...
        print("\n=== STATISTIK IEEE 57-Bus – Collapse Prediction ===")
        ...
        plt.title("Lead-Time Histogram – IEEE 57-Bus (20 Runs)")
        plt.xlabel("Phi-Split Zeitpunkt t [s]")
        plt.ylabel("Anzahl Runs")
        plt.grid(True, alpha=0.4)
        plt.legend()
        plt.savefig("ieee57_lead_time_histogram_v5.png", dpi=420, bbox_inches='tight')
        print("📸 Histogramm gespeichert als: ieee57_lead_time_histogram_v5.png")
        plt.show()
    else:
