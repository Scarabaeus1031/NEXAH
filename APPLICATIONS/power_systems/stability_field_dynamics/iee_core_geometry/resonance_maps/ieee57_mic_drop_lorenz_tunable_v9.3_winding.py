"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.3
...
winding_threshold = 18.0     # <-- nächster Schritt Richtung Z29/Z30
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.3 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v9.3 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v9.3_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v9.3_winding_{winding_threshold}.png")
    plt.show()
