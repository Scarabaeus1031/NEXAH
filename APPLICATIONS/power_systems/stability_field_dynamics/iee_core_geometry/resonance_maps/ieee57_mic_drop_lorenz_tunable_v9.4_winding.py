"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.4
WINDING-NUMBER TRIGGER – Feintuning auf Z29/Z30 (Threshold 17.8)
"""
...
winding_threshold = 17.8     # Feintuning
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.4 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v9.4 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v9.4_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v9.4_winding_{winding_threshold}.png")
    plt.show()
