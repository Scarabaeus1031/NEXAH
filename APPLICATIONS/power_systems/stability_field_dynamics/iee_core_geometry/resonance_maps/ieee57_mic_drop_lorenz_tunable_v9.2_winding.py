"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.2
WINDING-NUMBER TRIGGER – gezielt auf die 22-28 s Lücke (nach der 18-19)
"""
...
winding_threshold = 12.5     # <-- nächster Schritt Richtung Z29/Z30
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.2 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v9.2 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v9.2_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v9.2_winding_{winding_threshold}.png")
    plt.show()
