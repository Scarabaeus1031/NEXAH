"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.3
Smiling L + Hirtenstock + offener Durchfluss + Unity + 17-29-5
"""
...
def nexah_lorenz_ode(t, x, params):
    ...
    # harter Guard + late-boost für smiling Unity
    ...
    # kleiner late-boost ab t=30 damit der Drift sicher überschreitet
    if t > 30.0:
        d_dc += 0.8 * slow_start
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.3 (drift_threshold = {drift_threshold})")
    ...
    ax3d.set_title("Lorenz Core – smiling L + Hirtenstock + offener Durchfluss + Unity")
    ax3d.set_xlabel("c")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v8.3)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v8.3_threshold_{drift_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v8.3_threshold_{drift_threshold}.png")
    plt.show()
