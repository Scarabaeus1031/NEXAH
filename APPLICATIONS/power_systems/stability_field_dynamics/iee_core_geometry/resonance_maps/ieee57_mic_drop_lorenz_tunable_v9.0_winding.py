"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.0
WINDING-NUMBER TRIGGER – gezielt auf die 18-22 s Lücke (nach der 9)
"""
...
winding_threshold = 8.5      # <-- jetzt auf die nächste Lücke (nach der 9)
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v9.0 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v9.0 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v9.0_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v9.0_winding_{winding_threshold}.png")
    plt.show()
