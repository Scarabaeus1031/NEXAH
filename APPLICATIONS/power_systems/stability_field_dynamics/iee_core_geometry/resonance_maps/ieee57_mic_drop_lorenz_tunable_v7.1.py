"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v7.1
Genau auf deine Übergangspunkte 34/35/36/37 tunen
"""
...
drift_threshold = 4.8        # <--- hier tunen (4.5 → früher, 5.5 → später)
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v7.1 (drift_threshold = {drift_threshold})")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v7.1_threshold_{drift_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v7.1_threshold_{drift_threshold}.png")
    plt.show()
