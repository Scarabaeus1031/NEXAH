"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.8
WINDING-NUMBER TRIGGER – gezielt auf Z29/Z30 Lücke
"""
...
winding_threshold = 2.8      # <-- gezielt für Z29/Z30
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.8 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v8.8 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v8.8_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v8.8_winding_{winding_threshold}.png")
    plt.show()
