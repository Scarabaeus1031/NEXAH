"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.2
...
def nexah_lorenz_ode(t, x, params):
    ...
    # Slow-Start für lächelndes Plateau
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.2 (drift_threshold = {drift_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v8.2)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v8.2_threshold_{drift_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v8.2_threshold_{drift_threshold}.png")
    plt.show()
