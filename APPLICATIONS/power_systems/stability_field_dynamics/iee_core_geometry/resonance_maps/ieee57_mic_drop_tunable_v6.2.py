"""
NEXAH IEEE 57-Bus — TUNABLE v6.2
Mit max-Drift-Anzeige + etwas stärkerer Ramp
"""
...
drift_threshold = 5.5        # <--- hier kannst du testen (5.0, 5.5, 5.8, 6.0...)
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — TUNABLE v6.2 (drift_threshold = {drift_threshold})")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_tunable_v6.2_threshold_{drift_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_tunable_v6.2_threshold_{drift_threshold}.png")
    plt.show()
