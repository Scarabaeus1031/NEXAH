"""
NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.9
...
winding_threshold = 5.5      # <-- gezielt für Z29/Z30
...
if __name__ == "__main__":
    print(f"🚀 NEXAH IEEE 57-Bus — LORENZ TUNABLE v8.9 (Winding-Number Trigger = {winding_threshold})")
    ...
    ax2d.set_title("Collapse Prediction – IEEE 57-Bus (v8.9 Winding)")
    ...
    ax2d.legend()
    plt.tight_layout()
    plt.savefig(f"ieee57_lorenz_tunable_v8.9_winding_{winding_threshold}.png", dpi=420, bbox_inches='tight')
    print(f"📸 Plot gespeichert als: ieee57_lorenz_tunable_v8.9_winding_{winding_threshold}.png")
    plt.show()
