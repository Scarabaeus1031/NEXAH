# APPLICATIONS/power_systems/ieee_test_cases/dual_resonance_v15.py
...
def apply_dual_resonance(
    ...
    Returns:
        Fx_new, Fy_new, masks, radius, peaks, gap
    """
