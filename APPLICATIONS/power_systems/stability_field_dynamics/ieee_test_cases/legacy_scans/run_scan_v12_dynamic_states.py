...
def plot_states(M, states):
    ...
    plt.title("Detected States (Dynamic / Bipolar)")
    plt.show()
...
def plot_loops(loops):
    ...
    plt.title("Detected Loops (Dynamic Flow)")
    plt.show()


def plot_field_and_flow(landscape, Fx, Fy):
    plt.figure(figsize=(8, 6))
...
# =========================
def main():
    print("\n--- V12 Dynamic States / Regime Switching ---")
    ...
    plot_field_and_flow(landscape, Fx, Fy)
