...
def plot_flow(landscape, Fx, Fy):
    ...
    plt.title("V13b Neon Closure Flow Field")
    plt.show()
...
def plot_states(M, states):
    ...
    plt.title("Detected States (Neon Activated)")
    plt.show()
...
def main():
    ...
    # ===== PARTICLES =====
    particles = seed_bipolar(boundary, n_particles=100)
    ...
    states, labeled = extract_states_from_recurrence(
        M,
        threshold=0.12   # leicht sensibler für Neon
    )
